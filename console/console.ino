/*----------------------------------------------------------------------------------*
  ...
  Verify   WiFi.setPins(8,7,4,2) for Adafruit Feather M0 WiFi
           ...
           FCSTLAT = "33.88" FCSTLON = "-84.30" KPDK Peachtree Decalb, Atlanta
           FCSTLAT = "39.73" FCSTLON = "-104.99" KDNR Denver Stapleton 816 Acoma St, Denver CO 80204
...
const char* FCSTLAT    = "39.73";
const char* FCSTLON    = "-104.99";
